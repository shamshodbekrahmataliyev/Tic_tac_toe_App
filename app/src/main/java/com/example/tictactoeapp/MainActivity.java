       ...
       private void performAction(ImageView imageView, int selectedBoxPosition){
           ...
           if (playerTurn == 1){
               ...
               if (checkPlayerWin()){
                   ...
                   WinDialog winDialog = new WinDialog(MainActivity.this, playerOneName.getText().toString() + "\n" +
                           "o'yinda g'alaba qozondi", MainActivity.this);
                   winDialog.setCancelable(false);
                   winDialog.show();
               }
               else if (totalSelectedBoxes == 9){
                   WinDialog winDialog = new WinDialog(MainActivity.this, "Bu durang!", MainActivity.this);
                   winDialog.setCancelable(false);
                   winDialog.show();
               }
               else {
